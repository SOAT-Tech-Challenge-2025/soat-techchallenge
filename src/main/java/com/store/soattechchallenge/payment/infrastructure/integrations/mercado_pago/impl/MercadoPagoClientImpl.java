package com.store.soattechchallenge.payment.infrastructure.integrations.mercado_pago.impl;
...
import com.store.soattechchallenge.payment.infrastructure.integrations.mercado_pago.exception.MPNotFoundException;
...
public class MercadoPagoClientImpl implements MercadoPagoClient {
    ...
    public MercadoPagoClientImpl(MercadoPagoIntegrationConfig mercadoPagoIntegrationConfig) {
        this.ACCESS_TOKEN = mercadoPagoIntegrationConfig.getAccessToken();
